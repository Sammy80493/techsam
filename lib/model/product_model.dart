...
class Products {
  ...
  @override
  String toString() {
    return 'Products(id: $id, imgPath: $imgPath, price: $price, status: $status, name: $name, isFavourite: $isFavourite, desc: $desc)';
  }
}
...
//       isFavourite: false,
//       desc: 'Nice mouse pad for office, gaming and music studios'),
//   Products(
//       id: 3,
//       imgPath:
...
//       isFavourite: false,
//       desc: 'Nice mouse pad for office, gaming and music studio 900*400mm'),
//   Products(
//       id: 4,
//       imgPath:
...
//       name: 'HP Omen Mouse',
//       isFavourite: false,
//       desc: 'Omen Mouse sweetable for gaming and office work'),
//   Products(
//       id: 10,
//       imgPath:
...
//       isFavourite: false,
//       desc: 'Razer COBRA mouse Right-hand USB Type-A Optical 8500 DPI'),
//   Products(
//       id: 11,
//       imgPath:
...
//       isFavourite: false,
//       desc: 'Razer Orochi V2 Ultra in Muscat | Buy Mechanical Gaming Mouse'),
//   Products(
//       id: 12,
//       imgPath:
...
//       isFavourite: false,
//       desc: 'Hands-on: Corsair IronClaw RGB gaming mouse'),
//   Products(
//       id: 13,
//       imgPath:
...
//       isFavourite: false,
//       desc: 'MSI Gaming Mouse sweetable for games'),
//   Products(
//       id: 14,
//       imgPath:
...
//       isFavourite: false,
//       desc: 'MSI Gaming Keyboard sweetable for games'),
//   Products(
//       id: 16,
//       imgPath:
...
//       name: 'MSI Vigor GK50',
//       isFavourite: false,
//       desc: 'MSI Vigor GK50 Low Profile TKL Mechanical Keyboard'),
//   Products(
//       id: 18,
//       imgPath:
...
//       isFavourite: false,
//       desc: 'Razer Huntsman V2 TKL Optical Mechanical Gaming Keyboard'),
//   //GPU
//   Products(
//       id: 20,
//       imgPath:
...
//       isFavourite: false,
//       desc: """GPU : NVIDIA® GeForce RTX™ 3080 Ti, 
...
//       isFavourite: false,
//       desc: """IPS panel comes together for a crystal clear picture.
//            G-Sync compatible monitor has a 240Hz refresh rate and 1ms response time"""),
//   Products(
//       id: 34,
//       imgPath: 'https://xlr8it.in/wp-content/uploads/2021/09/hc5.png',
//       price: '270.80',
//       status: 'pending',
...
//       isFavourite: false,
//       desc: """ALKETRON - 8GB-DDR3-1866MHZ GAMING DESKTOP RAM"""),
//   Products(
//       id: 37,
//       imgPath: 'https://advanti.com/images/product/back-cover.png',
//       price: '80.80',
//       status: 'pending',
//       name: 'RANSOR Supersonic 8GB 3000MHz DDR4 RAM',
//       isFavourite: false,
//       desc: """8GB Single Module
//                 DDR4
//                 3000MHz
//                 18-18-18-38
//                 1.35V"""),
...
//       isFavourite: false,
//       desc: """FURY DDR5 2x8GB 6000MHz DIMM"""),
//   Products(
//       id: 39,
//       imgPath:
